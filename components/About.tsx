...
const About = ({ pageInfo }: Props) => {
  return (
    <motion.div 
        ...
        className="h-[200px] w-[200px] mt-[150px] md:h-86 md:w-86 md:mt-0 lg:h-96 lg:w-96 rounded-full object-cover md:rounded-lg"
        />

        <div className="space-y-5 px-0 mb-10 md:px-10">
            <h4 className="text-2xl md:text-4xl font-semibold">
                Here is a <span className="underline decoration-[#F7AB0A]/60">little</span> background
            </h4>
            <p className="text-base h-[200px] overflow-y-scroll scrollbar scrollbar-thin scrollbar-track-slate-500 scrollbar-thumb-[#F7AB0A] pr-5">
